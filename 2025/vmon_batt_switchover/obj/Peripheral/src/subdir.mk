...
Peripheral/src/%.o: ../Peripheral/src/%.c
	@	@	riscv-none-embed-gcc -march=rv32ecxw -mabi=ilp32e -msmall-data-limit=0 -msave-restore -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -fno-common -Wunused -Wuninitialized  -g -I"C:\MRS_DATA\workspace\vmon_batt_switchover\Debug" -I"C:\MRS_DATA\workspace\vmon_batt_switchover\Core" -I"C:\MRS_DATA\workspace\vmon_batt_switchover\User" -I"C:\MRS_DATA\workspace\vmon_batt_switchover\Peripheral\inc" -std=gnu99 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
	@	@
